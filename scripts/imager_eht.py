...
def image_in_eht(uvfits, prior_fits, maxit_first, maxit_iter,
    ...
    imp = imp.threshold(cutoff=clipfloor, fill_val=0.0)
    ...
    out = eh.imager_func(obs, imp, imp, imp.total_flux(),
                         ...
                         alpha_flux, alpha_cm, clipfloor=clipfloor,
...
if __name__ == "__main__":
    ...
    initial_fits = "/home/ilya/data/alpha/MOJAVE/1228+126_original_stack_I.fits"
    eht_image = image_in_eht(uvfits, initial_fits, clipfloor=0.01,
                             maxit_first=300, maxit_iter=100, frac_nchi2_to_stop=0.03,
                             d1="vis", alpha_d1=1,

# This corrects bias of alpha map given CC models of the artificial data
import os
...
for freq in freqs_obs_ghz:
    ...
    ccmodel_file = "model_cc_i_{}_noresid_filtered.fits".format(freq)
...
cc_itrue_convolved_low = create_image_from_fits_file(os.path.join(save_dir, "model_cc_i_{}_noresid_filtered.fits".format(freq_low))).image
cc_itrue_convolved_high = create_image_from_fits_file(os.path.join(save_dir, "model_cc_i_{}_noresid_filtered.fits".format(freq_high))).image
